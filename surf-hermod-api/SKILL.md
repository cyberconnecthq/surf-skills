...
surf-hermod-api/scripts/surf-api endpoints trading
surf-hermod-api/scripts/surf-api endpoints proxy

# 3. Show full endpoint details + curl example
surf-hermod-api/scripts/surf-api show /trading-data/price
